...
const getStudentService = (filters, paginationOption) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { page, limit, skip, sortBy, sortOrder } =
      paginationHelpers_1.paginationHelper.paginationCalculation(
        paginationOption
      );
...
const updateSingleStudentService = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { guardian, localGuardian, name } = payload,
      studentData = __rest(payload, ['guardian', 'localGuardian', 'name']);
    ...
    if (guardian && Object.keys(guardian).length > 0) {
      Object.keys(guardian).forEach(key => {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        updateStudentData[nameKey] = guardian[key];
      });
    }
    ...
    if (localGuardian && Object.keys(localGuardian).length > 0) {
      Object.keys(localGuardian).forEach(key => {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        updateStudentData[nameKey] = localGuardian[key];
      });
    }
