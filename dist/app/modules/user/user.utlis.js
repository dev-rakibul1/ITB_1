...
const findLastStudentId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const lastStudent = yield user_model_1.default
...
const generateStudentId = academicSemester =>
  __awaiter(void 0, void 0, void 0, function* () {
    const currentId =
      (yield findLastStudentId()) || (0).toString().padStart(5, '0');
    const fullIncrementId = (parseInt(currentId) + 1)
      .toString()
      .padStart(5, '0');
    let incrementId = `${
...
const findLastFacultyId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const lastFaculty = yield user_model_1.default
