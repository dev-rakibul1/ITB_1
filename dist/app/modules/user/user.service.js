...
const acadamicSemester_model_1 = __importDefault(require("../academicSemester/acadamicSemester.model"));
const student_model_1 = require("../student/student.model");
const user_model_1 = __importDefault(require("./user.model"));
const user_utlis_1 = __importStar(require("./user.utlis"));
const createStudentService = (student, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Set role
    user.role = 'student';
    const academicsemester = yield acadamicSemester_model_1.default.findById(student.academicSemester).lean();
    ...
    if (newUserAllData) {
        newUserAllData = yield user_model_1.default.findOne({ id: newUserAllData.id }).populate({
            path: 'student',
            populate: [
                {
