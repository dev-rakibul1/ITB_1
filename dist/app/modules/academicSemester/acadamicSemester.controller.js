...
const createAcademicSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield acadamicSemester_service_1.AcademicSemesterService.createSemester(
...
const getAllSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield acadamicSemester_service_1.AcademicSemesterService.getAllSemesterService(
        filters,
        paginationOptions
      );
    (0, sendResponse_1.default)(res, {
...
const getSingleSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield acadamicSemester_service_1.AcademicSemesterService.getSingleSemesterService(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const updateSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield acadamicSemester_service_1.AcademicSemesterService.updateSemesterService(
        id,
        updateData
      );
    (0, sendResponse_1.default)(res, {
...
const deleteSingleSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const deleteData = req.body;
    const result =
      yield acadamicSemester_service_1.AcademicSemesterService.deleteSingleSemesterService(
        id,
        deleteData
      );
    (0, sendResponse_1.default)(res, {
