...
const createAcademicDepartmentService = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = (yield academicDepartment_model_1.AcademicDepartment.create(payload)).populate('academicFaculty');
    return result;
});
const getAllAcademicDepartmentService = (filters, payload) => __awaiter(void 0, void 0, void 0, function* () {
    // search stream
    const { searchTerm } = filters, searchTermData = __rest(filters, ["searchTerm"]);
    const andConditions = [];
    if (searchTerm) {
        andConditions.push({
            $or: academicDepartment_constants_1.academicDepartmentSearchKeys.map(field => ({
                [field]: {
                    $regex: searchTerm,
                    $options: 'i',
                },
...
const updateAcademicDepartmentService = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicDepartment_model_1.AcademicDepartment.findByIdAndUpdate(id, payload, {
        new: true,
    });
    return result;
});
const deleteAcademicDepartmentService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const deleteDepartment = yield academicDepartment_model_1.AcademicDepartment.findByIdAndDelete(id).populate('academicFaculty');
    return deleteDepartment;
});
const getSingleAcademicDepartmentService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const singleDepartment = yield academicDepartment_model_1.AcademicDepartment.findById(id).populate('academicFaculty');
